...
public class LoginController implements Initializable {
    ...
    public void logar(){
    	...
    	// pega a sess�o do hibernate
    	Session session = HibernateUtil.getSession();
    	// cria caso default de usuario caso n�o exista no banco
    	Usuario user = null;
    	
    	if (session != null) {
    		try {
    			// tenta buscar um usu�rio no banco pelo username
    			...
    			if (!results.isEmpty()) {
    				...
    				// pega o usuario com username unico - a unicidade do username deve ser garantida na inser��o
    				user = results.get(0);
